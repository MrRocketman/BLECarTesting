...
@property(readwrite, nonatomic) NSArray *commandSectionNames;
@property(readwrite, nonatomic) NSArray *commandSectionDictionaryArrays;
...
- (id)init
{
    if(self = [super init])
    {
        ...
        self.commandSectionNames = @[@"Ignition", @"Controls", @"Exterior Lights", @"Interior Lights", @"Miscellaneous"];
        ...
        NSDictionary *section2Dictionary1 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             ...
                                             @"Locks", @"category",
                                             nil];
        NSDictionary *section2Dictionary2 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C51", @"baseCommand",
                                             @2, @"numberOfStates",
                                             ...
                                             @"Controls", @"category",
                                             nil];
        NSDictionary *section2Dictionary3 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C52", @"baseCommand",
                                             @2, @"numberOfStates",
                                             ...
                                             @"Controls", @"category",
                                             nil];
        NSDictionary *section2Dictionary4 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C53", @"baseCommand",
                                             @3, @"numberOfStates",
                                             ...
                                             @"Controls", @"category",
                                             nil];
        NSDictionary *section2Dictionary5 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C54", @"baseCommand",
                                             @2, @"numberOfStates",
                                             @[@"Top", @"Bottom"], @"stateLabels",
                                             @"S", @"stateCommand",
        ...
        NSDictionary *section2Dictionary6 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C55", @"baseCommand",
                                             @3, @"numberOfStates",
                                             @[@"Stop", @"Up", @"Down"], @"stateLabels",
                                             @"S", @"stateCommand",
                                             ...
                                             @"Controls", @"category",
                                             nil];
        NSDictionary *section2Dictionary7 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C56", @"baseCommand",
                                             @2, @"numberOfStates",
                                             @[@"Top", @"Bottom"], @"stateLabels",
                                             @"S", @"stateCommand",
                                             ...
                                             @"Controls", @"category",
                                             nil];
        NSDictionary *section2Dictionary8 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C57", @"baseCommand",
                                             @3, @"numberOfStates",
                                             @[@"Stop", @"Up", @"Down"], @"stateLabels",
                                             @"S", @"stateCommand",
                                             ...
                                             @"Controls", @"category",
                                             nil];
        NSDictionary *section2Dictionary9 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             @"C58", @"baseCommand",
                                             @2, @"numberOfStates",
                                             @[@"Close", @"Open",], @"stateLabels",
                                             @"S", @"stateCommand",
                                             ...
                                             @"Controls", @"category",
                                             nil];
        NSArray *section2Dictionaries = @[section2Dictionary1, section2Dictionary2, section2Dictionary3, section2Dictionary4, section2Dictionary5, section2Dictionary6, section2Dictionary7, section2Dictionary8, section2Dictionary9];
        ...
        NSDictionary *section3Dictionary6 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             ...
                                             @"Exterior Lights", @"category",
                                             nil];
        NSArray *section3Dictionaries = @[section3Dictionary1, section3Dictionary2, section3Dictionary3, section3Dictionary4, section3Dictionary5, section3Dictionary6];
        ...
        NSDictionary *section4Dictionary5 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                             ...
                                             @"Interior Lights", @"category",
                                             nil];
        NSArray *section4Dictionaries = @[section4Dictionary1, section4Dictionary2, section4Dictionary3, section4Dictionary4, section4Dictionary5];
